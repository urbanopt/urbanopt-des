...
class SetParameterValueMultiplier(MeasureBase):
    ...
    def description(self):
        return "Set the value of a model's parameter to the current value multiplied by the passed value."

    def modeler_description(self):
        return "Parse the Modelica file and set the value of the specified parameter to the current value times the multiplied value."
